...
public class XJedisClient {
    ...
    public class Lists {
        ...
        public long linsert(String key, LIST_POSITION where, String pivot, String value) {
            return linsert(SafeEncoder.encode(key), where, SafeEncoder.encode(pivot), SafeEncoder
                    .encode(value));
        }
    ...
    public ScanResult<String> scanKeys(String cursor, String pattern, int count) {
        Jedis jedis = getJedis();
    ...
    public ScanResult<Map.Entry<String, String>> scanHash(String key, String cursor, String pattern, int count) {
        Jedis jedis = getJedis();
        ScanParams params = new ScanParams();
        params.match(pattern);
        params.count(count);
    ...
    public ScanResult<String> scanSet(String key, String cursor, String pattern, int count) {
        Jedis jedis = getJedis();
        ScanParams params = new ScanParams();
        params.match(pattern);
        params.count(count);
